/**
 * ULRIC-X MD v13.2.1 - Main Message Handler
 *
 * NEVER SILENT command system:
 * - Supports . and / prefixes
 * - Unknown commands suggest closest matches
 * - Empty prefix prompts user to type a command
 * - Wrong usage shows correct syntax
 * - Private mode restricts to owner only
 */
const fs = require('fs');
